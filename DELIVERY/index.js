...
function displayItems(){
    ...
    var salats=  document.getElementById('salats');;
    ...
    const salatsData= foodItem.filter((item)=>item.category=='salats');
    const meatData= foodItem.filter((item)=>item.category=='meat');
